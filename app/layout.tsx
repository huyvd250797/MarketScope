...
export const metadata: Metadata = {
  title: 'MarketScope V0.13.0',
  description: 'Mobile-first Crypto Spot, Vietnam Stock and Forex analysis with Alert Center, Opportunity Monitoring, Smart Scanner, Forecast Validation, Strategy Profiles and Data Quality Guard.',
