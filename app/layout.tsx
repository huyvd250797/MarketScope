...
export const metadata: Metadata = {
  title: 'MarketScope V0.5.0',
  description: 'Mobile-first Crypto Spot and Vietnam Stock analysis with Entry/SL/TP, Position Exit, Backtest and Win-rate Calibration.',
