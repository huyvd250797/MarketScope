...
export const STRATEGY_PROFILES: Record<EffectiveStrategyProfile, StrategyProfileConfig> = {
  SHORT_TERM: {
    ...
    preferredIntervals: { CRYPTO: ['15m', '1h'], STOCK: ['15m', '1h'], FOREX: ['15m', '1h'] },
    ...
    position: { stopAtr: 0.9, profitProtectPercent: { CRYPTO: 2.5, STOCK: 1.5, FOREX: 1.2 }, targetsAtr: [0.65, 1.35, 2.2], trailingAtr: 0.16 },
  },
  SWING: {
    ...
    preferredIntervals: { CRYPTO: ['1h', '4h', '1d'], STOCK: ['1h', '1d'], FOREX: ['1h', '4h', '1d'] },
    ...
    position: { stopAtr: 1.1, profitProtectPercent: { CRYPTO: 4, STOCK: 2.5, FOREX: 2.0 }, targetsAtr: [0.9, 2.1, 3.8], trailingAtr: 0.22 },
  },
  MEDIUM_TERM: {
    ...
    preferredIntervals: { CRYPTO: ['4h', '1d'], STOCK: ['1d', '1w'], FOREX: ['4h', '1d'] },
    ...
    position: { stopAtr: 1.35, profitProtectPercent: { CRYPTO: 6, STOCK: 4, FOREX: 3.0 }, targetsAtr: [1.35, 3.0, 5.2], trailingAtr: 0.30 },
  },
  LONG_TERM: {
    ...
    preferredIntervals: { CRYPTO: ['1d', '1w'], STOCK: ['1d', '1w'], FOREX: ['1d', '1w'] },
    ...
    position: { stopAtr: 1.65, profitProtectPercent: { CRYPTO: 9, STOCK: 6, FOREX: 4.5 }, targetsAtr: [2.0, 4.5, 7.5], trailingAtr: 0.38 },
  },
};
