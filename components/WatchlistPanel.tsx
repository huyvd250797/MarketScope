  ...
  return (
    <section className="panel-page watchlist-page">
      ...
      <div className="watch-note">
        <span>i</span>
        <p>V0.13.0 lưu Strategy Profile theo từng mã/timeframe. AUTO có thể đổi effective profile khi regime/volatility thay đổi; calibrated rate luôn backtest theo effective profile hiện tại. Monitoring chạy xuyên session khi app đang visible và đẩy event vào Alert Center; chưa phải cloud push 24/7 khi app đóng hoàn toàn. Calibrated rate chỉ hiện khi backtest đủ điều kiện và không phải cam kết xác suất thắng tương lai.</p>
      </div>
    </section>
  );
}
